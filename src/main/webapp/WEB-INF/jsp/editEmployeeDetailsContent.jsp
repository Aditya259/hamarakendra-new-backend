                      ...
                      <form action="updateEmployeeData" method="post">
                       <input
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="basic-default-name"  name="name" value="<%=bookService.getEmployeeName()%>" placeholder="Enter your Full Name Ex- John Doe" />
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input
                              ...
                              value="<%=bookService.getEmployeeMobileNo() %>"
                              name="mobileNo"
                            />
                          </div>
                        </div>
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <input
                                ...
                                value="<%=bookService.getEmployeeEmailAddress() %>"
                                name="emailId"
                              />
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input
                              ...
                              value="<%=bookService.getEmployeeAddress() %>"
                              name = "address1"
                            />
                          </div>
                        </div>
                         <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input
                              ...
                              placeholder=""
                              aria-describedby="basic-default-phone"
                              value="<%=bookService.getEmployeeCity() %>"
                              name = "city"
                            />
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input
                              ...
                              placeholder=""
                              aria-describedby="basic-default-phone"
                              value="<%=bookService.getEmployeeState() %>"
                              name = "state"
                            />
                          </div>
                        </div>
                         <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input
                              ...
                              placeholder=""
                              aria-describedby="basic-default-phone"
                              value="<%=bookService.getEmployeeCountry() %>"
                              name = "country"
                            />
                          </div>
                        </div>
                         ...
                         <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input
                              ...
                              placeholder=""
                              aria-describedby="basic-default-phone"
                              value="<%=bookService.getEmployeeUserName() %>"
                              name = "username"
                            />
                          </div>
                        </div>
                          ...
                          <div class="col-sm-10">
                            <input
                              ...
                              placeholder=""
                              aria-describedby="basic-default-phone"
                              value="<%=bookService.getEmployeePassword() %>"
                              name = "password"
                            />
                          </div>
                        </div>
